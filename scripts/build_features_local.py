...
def build_features(input_path: str, output_dir: str = "data/features") -> None:
    ...
    user_to_idx: Dict[int, int] = {u: i for i, u in enumerate(interacoes["visitorid"].unique())}
    item_to_idx: Dict[int, int] = {it: i for i, it in enumerate(interacoes["itemid"].unique())}
