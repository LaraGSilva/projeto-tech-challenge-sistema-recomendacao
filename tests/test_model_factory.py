...
def test_model_factory_create_neumf_light():
    ...
    assert model.user_embed.num_embeddings == EXPECTED_RECS_COUNT
    assert model.item_embed.embedding_dim == EXPECTED_EMBEDDING_DIM
...
def test_model_factory_create_popularity_with_mappings():
    ...
    mappings = {"user_to_idx": {101: 0}, "idx_to_item": {0: 500}}
